...
DankModal {
    ...
    modalFocusScope.Keys.onPressed: event => {
        ...
        case Qt.Key_Enter:
            ...
            event.accepted = true;
            break;
        case Qt.Key_1: NiriDS.apply("internal_only"); event.accepted = true; break;
        case Qt.Key_2: NiriDS.apply("external_only"); event.accepted = true; break;
        case Qt.Key_3: NiriDS.apply("extend"); event.accepted = true; break;
        }
    }
            ...
            Column {
                ...
                Column {
                    ...
                    DankListView {
                        ...
                        model: ScriptModel { values: [...NiriDS.displays] }
                        delegate: Rectangle {
